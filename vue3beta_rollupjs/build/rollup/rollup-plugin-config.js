...
async function vueWarpper() {
  ...
  if (isDev) {
    ...
    fileName = 'csii-vx-mobile-dev.css'
  } else if (isProduction) {
    fileName = process.env.BUILD_TYPE !== 'variables' ? 'csii-vx-mobile.css' : 'csii-vx-mobile.variable.css'
    distDir = LIB_DIR
  } else if (isTest) {
    distDir = TEST_OUTPUT_DIR
    fileName = 'csii-vx-mobile-test.css'
  }
...
const basicAlias = {
  ...
  '@csii/vx-mobile/lib': resolve('lib'),
...
const rollupPluginFactory = async () =>  {
  ...
  ...(conditionHelper(!isDev, [
    aliasPlugin(Object.assign(basicAlias, {
      '@csii/vx-mobile': resolve('lib/csii-vx-mobile.esm.js'),
    })),
  ])),
  ...(conditionHelper(isDev, [
    aliasPlugin(Object.assign(basicAlias, {
      '@csii/vx-mobile': resolve('src/components'),
    })),
  ])),
  nodeResolvePlugin({
  ...
  ...(conditionHelper(isTest, [
    common({
      exclude: ['src/components/_util/*.js'],
