...
```javascript
import { ImageReader } from '@csii/vx-mobile'
import imageProcessor from '@csii/vx-mobile/lib/image-reader/image-processor' // 图片处理插件，用法参考#imageProcessor
...
```javascript
import imageProcessor from '@csii/vx-mobile/lib/image-reader/image-processor'
