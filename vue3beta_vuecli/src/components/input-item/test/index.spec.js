import {InputItem} from '@csii/vx-mobile'
...
describe('InputItem - Operation', () => {
  ...
  test('input-item with clear btn', () => {
    ...
    const clearBtn = wrapper.find('.ui-input-item-clear')
  ...
  test('input-item with number-keyborad', done => {
    ...
    wrapper.vm.focus()
    setTimeout(() => {
      const keyborad = wrapper.find('.ui-number-keyboard')
  ...
  test('input-item disabled', () => {
    ...
    const input = wrapper.find('.ui-input-item-fake')
  ...
  test('should show error slot', async () => {
    ...
    expect(wrapper.contains('.ui-input-item-msg')).toBe(false)
    wrapper.vm.isError = true
    await wrapper.vm.$nextTick(() => {
      expect(wrapper.contains('.ui-input-item-msg')).toBe(true)
      expect(wrapper.find('.ui-input-item-msg').text()).toBe('errorMsg')
    })
