import {Picker} from 'csii-vx-mobilele'
import PickerColumn from '@csii/vx-mobile/components/picker/picker-column'
...
describe('Picker - Operation', () => {
  ...
  test('create a picker', done => {
    ...
    setTimeout(() => {
      ...
      const cancelmBtn = wrapper.find('.ui-popup-cancel')
  ...
  test('create a picker column', done => {
    ...
    wrapper.vm.refresh(() => {
      ...
      const hook = wrapper.findAll('.ui-picker-column-hook').at(0)
