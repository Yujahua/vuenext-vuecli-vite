<template>
  <div class="ui-example-child ui-example-child-popup ui-example-child-popup-2">
    <ui-button @click="showPopUp('align')">标题居左</ui-button>
    <ui-popup
      class="inner-popup"
    ...
    >
      ...
      ></ui-popup-title-bar>
      <div class="ui-example-popup ui-example-popup-align">
    ...
    <ui-button @click="showPopUp('top')">无遮罩层</ui-button>
    <ui-popup
    ...
    <ui-button @click="showPopUp('mask')">禁用遮罩层点击</ui-button>
    <ui-popup
