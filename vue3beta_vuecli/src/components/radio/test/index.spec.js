import Vue from 'vue'
import {Radio, RadioBox, RadioGroup, RadioList} from '@csii/vx-mobile'
...
describe('Radio', () => {
  ...
  it('create a radio', () => {
    ...
    wrapper.find('.ui-radio').trigger('click')
  ...
  it('create a radio list', done => {
    ...
    expect(wrapper.findAll('.ui-radio-item').length).toEqual(3)
    wrapper
      .findAll('.ui-radio-item')
      .at(1)
      .trigger('click')
    expect(
      wrapper
    ...
    wrapper.vm.$nextTick(() => {
      expect(wrapper.findAll('.ui-radio-item').length).toEqual(2)
      done()
    })
  })
  ...
  it('radio group', () => {
    ...
    wrapper = mount(RadioGroup, {
      ...
      slots: {
        default: ['<ui-radio name="a"/>', '<ui-radio name="b"/>'],
      },
      listeners: {
        input(val) {
          value = val
  ...
  it('radiokbox click event', () => {
    ...
    const radioBox = wrapper.find('.ui-radio-box')
  ...
  it('radiobox group', () => {
    ...
    wrapper = mount(RadioGroup, {
      ...
      slots: {
        default: ['<ui-radio-box name="a"/>', '<ui-radio-box name="b"/>'],
      },
      listeners: {
        input(val) {
          value = val
    ...
    const radios = wrapper.findAll('.ui-radio-box')
    expect(radios.at(0).classes('is-checked')).toBe(true)
  ...
  it('create a radio list with input', () => {
    ...
    const input = wrapper.find('.ui-input-item-input')
    input.trigger('focus')
