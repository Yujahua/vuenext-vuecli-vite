...
import ScrollViewRefresh from '@csii/vx-mobile/components/scroll-view/refresh'
import ScrollViewMore from '@csii/vx-mobile/components/scroll-view/more'
...
describe('ScrollView', () => {
  ...
  it('create scroll-view', () => {
    ...
    const scrollView = wrapper.find('.ui-scroll-view')
