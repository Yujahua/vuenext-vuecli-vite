...
describe('Selector - Operation', () => {
  ...
  test('selector events choose', done => {
    ...
    wrapper.vm.$nextTick(() => {
      wrapper.find('.ui-radio-item').trigger('click')
  ...
  test('selector events confirm', done => {
    ...
    wrapper.vm.$nextTick(() => {
      const item = wrapper.find('.ui-radio-item')
      const confirmBtn = wrapper.find('.ui-popup-confirm')
      item.trigger('click')
      expect(wrapper.vm.tmpActiveIndex).toBe(0)
  ...
  test('selector events cancel', done => {
    ...
    wrapper.vm.$nextTick(() => {
      const cancelBtn = wrapper.find('.ui-popup-cancel')
  ...
  test('selector multi select', done => {
    ...
    wrapper.vm.$nextTick(() => {
      const item = wrapper.find('.ui-check-item')
      const confirmBtn = wrapper.find('.ui-popup-confirm')
