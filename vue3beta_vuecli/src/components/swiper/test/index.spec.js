...
describe('Swiper', () => {
  ...
  test('create a simple swiper', done => {
    ...
    expect(wrapper.classes('ui-swiper')).toBe(true)
  ...
  test('create a swiper item', () => {
    ...
    expect(wrapper.findAll('.ui-swiper-item').at(0).element.style.height).toBe('auto')
  })
  ...
  test('create a vertical swiper item', () => {
    ...
    expect(wrapper.findAll('.ui-swiper-item').at(0).element.style.width).toBe('auto')
  })
