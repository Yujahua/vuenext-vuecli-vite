<template>
  <div class="ui-cg">
    <h1 class="ui-cg-title">CSII VX Mobile</h1>
    <h1 class="ui-cg-subtitle">面向金融场景的移动端Vue组件库</h1>
    <div class="ui-cg-logo"></div>
    <section
    ...
    >
      ...
      >
        ...
        <ui-icon name="arrow-right" size="md"></ui-icon>
      </div>
    ...
    <h1 class="ui-cg-copyright">Produced By CSII VX - FDC &times; MFE</h1>
  </div>
</template>
<script>
import {ref} from 'vue'
...
export default {
  ...
  setup() {
    ...
    // const goToComponent = (path) => $router.push(path)
    const goToComponent = function(path) {
